...
import { groupRecords, groupDelete } from "../../services/groups";
import AppContext from "../../contexts/AppContext";

import ZoneModel from "./GroupModal";
...
class ManageGroups extends Component {
  ...
  delete = () => {
    ...
    groupDelete(this.state.selectedId)
      .then((res) => {
        this.getData();
      })
      .catch((error) => {
  ...
  render() {
    return (
      <Fragment>
        ...
        >
          <Fragment>
            <div className="map-db absolute z-20 bg-white right-0 p-8">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th className="relative py-3 border-b border-gray-200 bg-gray-50  text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                              {this.renderOrder("name", "right-6")}
                              Name
                            </th>
                            <th className="relative  py-3 border-b border-gray-200 bg-gray-50  text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                              {this.renderOrder("Description", "right-11")}
                              Description
                            </th>

                            <th className="relative pr-8  py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                              Actions
                            </th>
                          </tr>
                        </thead>
                        <tbody className="bg-white">
                          {this.state.items.map((item, index) => (
                            ...
                            >
                              ...
                              <td className="pr-5 py-2 whitespace-no-wrap text-right border-b border-gray-200 text-xs leading-5 font-medium">
        ...
        {this.state.showCreate || this.state.showUpdate ? (
          <GroupModal
            title={this.state.showUpdate ? "update group" : "create group"}
...
ManageGroups.contextType = AppContext;
