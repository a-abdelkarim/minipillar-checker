...
import DeviceModel from "../ManageDevices/DeviceModel";
                      ...
                      <thead>
                        <tr>
                          ...
                          <th className="relative pr-8 px-4 py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                            {this.renderOrder("name")}
                            Name
                          </th>

                          <th className="relative pr-8 px-4 py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                            {this.renderOrder("description")}
                            Description
                          </th>
                          <th className="relative pr-8 px-4 py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                            {this.renderOrder("code")}
                            Code
                          </th>
                          <th className="relative pr-8 px-4 py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                            {this.renderOrder("hardware")}
                            Hardware
                          </th>
                          <th className="relative pr-8 px-4 py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                            {this.renderOrder("status")}
                            status
                          </th>
                          <th className="relative pr-8 px-4 py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                            Actions
